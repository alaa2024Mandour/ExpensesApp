  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ExpensesCubit,Status>(
      ...
      builder: (BuildContext context, state) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text('Welcome In Your Expenses App',style: TextStyle(fontSize: 15),),
                ...
                onPressed: (){
                  showModalBottomSheet(
                    ...
                    builder: (context) =>DraggableScrollableSheet(
                        ...
                        expand: false,
                        builder: (context, scrollController) => newExpenses(
                ...
                Expanded(
                  child: ListView.separated(
                      itemBuilder: (context,index) => Dismissible(
                          ...
                          child: expensesItem(model: registeredExpenses, index: index)
                      ),
